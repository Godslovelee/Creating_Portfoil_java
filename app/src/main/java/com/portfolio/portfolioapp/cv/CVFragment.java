...
public class CVFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        items = new ArrayList<>();
        items.add(new CVItem("20 April 2018",getString(R.string.portfolio_tab)));
        items.add(new CVItem("20 May 2021",getString(R.string.portfolio_tab)));
        items.add(new CVItem("25 July 2019",getString(R.string.portfolio_tab)));
        items.add(new CVItem("20 April 2020",getString(R.string.lorem_text2)));
